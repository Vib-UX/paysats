...
- **Extended payment surface (roadmap):** wrapped and bridged BTC variants (**cbBTC**, **BTCB**, **WBTC**, **ZBTC**), and other assets as we widen deposit options — native BTC stays on Lightning + sats.
